...
class YuePromise extends Component {
    ...
    componentDidMount() {
        $('.yuekan').click(function () {
            document.querySelector('#EstateID').value=document.querySelector('.yuekan').id;
            document.getElementById('OrderEstateName').value=document.querySelector('.yuekan').getAttribute('data-estName');
    ...
    yuyue(e) {
        ...
        var EstateID =query("EstateID")|| $('#EstateID').val();
        let OrderEstateName=document.querySelector('#OrderEstateName').value;
        ...
        if(!isClose){
            ...
            var sendMessage = {
                ...
                "OrderFlag": 2,
                'ShareCode': sharecode,
                'OrderEstateName':OrderEstateName
            }
            Log.log('sendMessage',sendMessage);
